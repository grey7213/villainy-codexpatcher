    ...
    <n-space vertical size="large">
      ...
      <n-card :title="$t('cooperation.tokenTitle')" size="small">
        <n-space vertical size="small">
          ...
          <n-button
            tag="a"
            href="https://villainy.top"
            target="_blank"
            rel="noreferrer"
            type="primary"
            secondary
            class="relay-site-link"
          >
            {{ $t('cooperation.tokenSite') }} · villainy.top
          </n-button>
        </n-space>
      </n-card>
      ...
      <n-card :title="$t('cooperation.contactTitle')" size="small">
        <div class="contact-icons">
          <a class="contact-icon" href="mqqwpa://im/chat?chat_type=wpa&uin=89045349&version=1&src_type=web&web_src=villainy-patcher" aria-label="QQ">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path d="M21.395 15.035a40 40 0 0 0-.803-2.264l-1.079-2.695c.001-.032.014-.562.014-.836C19.526 4.632 17.351 0 12 0S4.474 4.632 4.474 9.241c0 .274.013.804.014.836l-1.08 2.695a39 39 0 0 0-.802 2.264c-1.021 3.283-.69 4.643-.438 4.673.54.065 2.103-2.472 2.103-2.472 0 1.469.756 3.387 2.394 4.771-.612.188-1.363.479-1.845.835-.434.32-.379.646-.301.778.343.578 5.883.369 7.482.189 1.6.18 7.14.389 7.483-.189.078-.132.132-.458-.301-.778-.483-.356-1.233-.646-1.846-.836 1.637-1.384 2.393-3.302 2.393-4.771 0 0 1.563 2.537 2.103 2.472.251-.03.581-1.39-.438-4.673" />
            </svg>
          </a>
          <n-popover trigger="click" placement="top" :width="220">
            <template #trigger>
              <button class="contact-icon" type="button" aria-label="WeChat">
                <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="wechat-popover">
              <img src="/wechat-villainy.jpg" alt="Villain Y 微信" />
              <span>扫码添加 Villain y</span>
            </div>
          </n-popover>
